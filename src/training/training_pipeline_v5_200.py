...
def train():
    ...
    for epoch in range(num_epochs):
        ...
        plt.tight_layout()
        plt.savefig(save_path_confusion_matrix, bbox_inches='tight', dpi=300)  
        plt.close()
...
sweep_configuration = {
    ...
    'metric': {
        'goal': 'maximize',  
        'name': 'val/f1_score_macro'   # metric to optize
    },
    'parameters': {
        'learning_rate': {
...
sweep_id = wandb.sweep(sweep=sweep_configuration, project="my-thirty-five-sweep")

...
def train():
    ...
    if(wandb.config.lr_scheduler == 'CosineAnnealingLR'):
        ...
        scheduler = ReduceLROnPlateau(optimizer, 'max', patience=4, factor=0.6)
    else:
        scheduler = None
...
sweep_id = wandb.sweep(sweep=sweep_configuration, project="my-twenty-eigth-sweep")
